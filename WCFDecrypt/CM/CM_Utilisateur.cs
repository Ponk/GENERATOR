...
namespace WCFDecrypt.CM
{
    ...
    {
        private WCFDecrypt.CAD.CAD oCAD;
        private WCFDecrypt.EM.EM_Utilisateur oUtilisateur;
        private System.Data.DataSet oDS;
        private bool result;

        public CM_Utilisateur()
        {
            this.oCAD = new WCFDecrypt.CAD.CAD();
            this.oUtilisateur = new WCFDecrypt.EM.EM_Utilisateur();
